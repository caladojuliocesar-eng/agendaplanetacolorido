      ...
      <header style={{
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{
            ...
            background: "rgba(249,115,22,0.2)", padding: "8px 16px", borderRadius: 12,
            marginBottom: 16, border: "1px solid rgba(249,115,22,0.3)",
          }}>
            <span style={{ fontSize: 20 }}>👩‍💼</span>
            <span style={{ fontSize: 12, fontWeight: 800, color: "#FB923C", letterSpacing: "0.05em" }}>
              VISÃO DIRETORA — MODO DEMONSTRAÇÃO
            </span>
          </div>

          <h1 style={{ fontSize: 32, fontWeight: 800, margin: "12px 0 8px", letterSpacing: "-0.02em" }}>
            Painel Pedagógico — Otto
          </h1>
          <p style={{ color: "#94A3B8", margin: 0, fontSize: 15 }}>
            {logs.length} observações registradas pela professora Ana • Berçário II
          </p>
        </div>
      </header>
      ...
      <div style={{ maxWidth: 900, margin: "-48px auto 0", padding: "0 24px 64px", position: "relative", zIndex: 2 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16, marginBottom: 32 }}>
          ...
          <div style={{ background: "white", borderRadius: 20, padding: "24px 28px", border: "1px solid #F1F5F9", display: "flex", alignItems: "center", gap: 20, boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
            ...
            <div>
              ...
              <p style={{ margin: 0, fontSize: 11, color: "#94A3B8" }}>{logs.length > 0 ? Math.round((positivos / logs.length) * 100) : 0}% do total</p>
            </div>
          </div>
          <div style={{ background: "white", borderRadius: 20, padding: "24px 28px", border: "1px solid #F1F5F9", display: "flex", alignItems: "center", gap: 20, boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
            ...
            <div>
              <p style={{ margin: 0, fontSize: 13, color: "#64748B", fontWeight: 600 }}>Pontos de Atenção</p>
              <p style={{ margin: 0, fontSize: 28, fontWeight: 800, color: "#EF4444" }}>{atencoes}</p>
              <p style={{ margin: 0, fontSize: 11, color: "#94A3B8" }}>{logs.length > 0 ? Math.round((atencoes / logs.length) * 100) : 0}% do total</p>
            </div>
          </div>
        </div>
        ...
        {reportContent && !reportApproved && (
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24, borderBottom: "1px solid #F1F5F9", paddingBottom: 16 }}>
              ...
              <div style={{ flex: 1 }}>
                <h3 style={{ margin: 0, fontSize: 20, fontWeight: 800, color: "#1E293B" }}>
                  {isEditing ? "Editando Relatório" : "Rascunho da IA (Revisão da Coordenação)"}
                </h3>
            ...
            {/* AI Adjust Prompt */}
            <div style={{
              marginTop: 24, background: "#F8FAFC", borderRadius: 16, padding: 20,
              ...
              <div style={{ display: "flex", gap: 12, alignItems: "flex-end" }}>
                <input
                  ...
                  placeholder='Ex: "Dê mais ênfase na socialização" ou "Suavize o trecho sobre alimentação"'
                  onKeyDown={(e) => { if (e.key === "Enter") handleAdjustWithAI(); }}
                  style={{
                    flex: 1, padding: "14px 18px", borderRadius: 12, border: "1px solid #CBD5E1",
                ...
                <button
                  ...
                  style={{
                    ...
                    background: adjusting || !adjustPrompt.trim() ? "#CBD5E1" : "#6366F1",
              ...
              <p style={{ margin: "8px 0 0", fontSize: 11, color: "#94A3B8" }}>
                A IA vai reescrever o relatório incorporando sua instrução, sem perder o contexto original.
              </p>
            </div>
        ...
        {reportContent && reportApproved && (
          <div style={{ marginTop: 8 }}>
            ...
            <div className="printable-a4" style={{
              ...
              minHeight: 1123, margin: "0 auto", maxWidth: 794,
              ...
              <div style={{ display: "flex", justifyContent: "space-between", marginTop: 80, paddingTop: 40 }}>
