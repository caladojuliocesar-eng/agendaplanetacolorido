      ...
      <section id="acesso" className="max-w-5xl mx-auto px-6 py-32 text-center">
        <div className="bg-gradient-to-br from-[#1e293b] to-[#0f172a] rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden shadow-2xl">
          <div className="relative z-10">
            ...
            {/* Novo: Card Inteligência Pedagógica */}
            <div className="border-t border-white/10 pt-8">
              <p className="text-slate-500 text-xs uppercase tracking-widest font-bold mb-4">✨ Novo Recurso</p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Link href="/showroom/professora" className="bg-emerald-500/10 border border-emerald-500/20 p-5 rounded-2xl group hover:bg-emerald-500/20 transition-all block" style={{ textDecoration: "none" }}>
                  <span className="block text-2xl mb-2">👩‍🏫</span>
                  <span className="block text-xs font-bold text-emerald-400 mb-1">Notas da Professora</span>
                  <p className="text-xs text-slate-400">Input de observações com IA</p>
                </Link>
                <Link href="/showroom/diretora" className="bg-orange-500/10 border border-orange-500/20 p-5 rounded-2xl group hover:bg-orange-500/20 transition-all block" style={{ textDecoration: "none" }}>
                  ...
                  <p className="text-xs text-slate-400">Geração, edição e aprovação com IA</p>
                </Link>
              </div>
            </div>
          </div>
