...
export default function ApresentacaoPublicaPage() {
  return (
    <div style={{ minHeight: "100vh", background: "#F8FAFC", padding: "24px 16px 64px 16px" }}>
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, padding: "0 8px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 13, fontWeight: 900, color: "#0F172A", letterSpacing: "0.05em", textTransform: "uppercase" }}>
              OTTOMATIC <span style={{ color: "#F97316" }}>TECH LABS</span>
            </span>
          </div>
          <span style={{ fontSize: 11, fontWeight: 700, color: "#64748B", background: "#E2E8F0", padding: "4px 10px", borderRadius: 12 }}>
        ...
        <header style={{
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12, marginBottom: 16 }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(249, 115, 22, 0.15)", color: "#FB923C", border: "1px solid rgba(249, 115, 22, 0.3)", padding: "6px 14px", borderRadius: 20, fontSize: 12, fontWeight: 800 }}>
        ...
        <section style={{ marginBottom: 40 }}>
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(170px, 1fr))", gap: 12, width: "100%", margin: "0 auto 28px", textAlign: "left" }}>
                {/* Etapa 1 */}
              ...
              <div style={{ display: "inline-flex", alignItems: "center", gap: 12, background: "linear-gradient(135deg, #EA580C, #D97706)", color: "white", padding: "14px 28px", borderRadius: 16, fontWeight: 800, fontSize: 15, boxShadow: "0 6px 20px rgba(234, 88, 12, 0.3)" }}>
                <span>🚀 Proposta Executiva — OttoMatic Tech Labs</span>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Corporate Footer */}
        <footer style={{ marginTop: 48, paddingTop: 28, borderTop: "1px solid #E2E8F0", textAlign: "center", color: "#64748B", fontSize: 13 }}>
          <p style={{ margin: "0 0 6px 0", fontWeight: 900, color: "#0F172A", fontSize: 14, letterSpacing: "0.02em" }}>
            OTTOMATIC <span style={{ color: "#F97316" }}>TECH LABS</span>
          </p>
          <p style={{ margin: "0 0 12px 0", color: "#64748B", fontSize: 13, fontWeight: 600 }}>
            Smart Tech Solutions — Sistemas Digitais e Automação de Alta Performance
          </p>
          <p style={{ margin: 0, fontSize: 11, color: "#94A3B8" }}>
            © {new Date().getFullYear()} OttoMatic Tech Labs. Todos os direitos reservados.
          </p>
        </footer>
